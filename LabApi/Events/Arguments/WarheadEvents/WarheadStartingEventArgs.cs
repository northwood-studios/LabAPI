...
/// </summary>
public class WarheadStartingEventArgs : EventArgs, ICancellableEvent, IPlayerEvent
{
    /// <summary>
    ...
    public WarheadStartingEventArgs(Player player, bool isAutomatic, bool suppressSubtitles, AlphaWarheadSyncInfo warheadState)
    {
        IsAllowed = true;
        Player = player;
