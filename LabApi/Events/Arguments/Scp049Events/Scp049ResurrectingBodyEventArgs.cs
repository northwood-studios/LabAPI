...
/// </summary>
public class Scp049ResurrectingBodyEventArgs : EventArgs, ICancellableEvent, IPlayerEvent
{
    /// <summary>
    ...
    public Scp049ResurrectingBodyEventArgs(Ragdoll ragdoll, Player target, Player player)
    {
        Ragdoll = ragdoll;
        Target = target;
        Player = player;
