...
/// </summary>
public class Scp049StartingResurrectionEventArgs : EventArgs, ICancellableEvent, IPlayerEvent
{
    /// <summary>
    ...
    public Scp049StartingResurrectionEventArgs(bool canResurrect, Ragdoll ragdoll, Player target, Player player)
    {
