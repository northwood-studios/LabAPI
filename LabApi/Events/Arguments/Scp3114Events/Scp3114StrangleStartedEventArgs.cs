...
/// <summary>
/// Represents the arguments for the <see cref="Handlers.Scp3114Events.StrangleStarted"/> events.
/// </summary>
public class Scp3114StrangleStartedEventArgs : EventArgs, IPlayerEvent, ITargetEvent
{
    /// <summary>
    /// Initializes a new instance of the <see cref="Scp3114StrangleStartedEventArgs"/> class.
    /// </summary>
