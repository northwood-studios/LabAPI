...
/// <summary>
/// Represents the arguments for the <see cref="Handlers.Scp3114Events.StrangleAborting"/> events.
/// </summary>
public class Scp3114StrangleAbortingEventArgs : EventArgs, IPlayerEvent, ITargetEvent, ICancellableEvent
{
    /// <summary>
    /// Initializes a new instance of the <see cref="Scp3114StrangleAbortingEventArgs"/> class.
    /// </summary>
