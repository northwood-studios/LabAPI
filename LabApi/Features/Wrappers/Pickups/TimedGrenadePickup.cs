...
public class TimedGrenadePickup : Pickup
{
    ...
    /// </summary>
    public static new Dictionary<BaseTimedGrenadePickup, TimedGrenadePickup> Dictionary { get; } = [];

    /// <summary>
    /// A reference to all instances of <see cref="TimedGrenadePickup"/>.
    /// </summary>
    public static new IReadOnlyCollection<TimedGrenadePickup> List => Dictionary.Values;
