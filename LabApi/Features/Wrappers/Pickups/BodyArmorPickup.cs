...
public class BodyArmorPickup : Pickup
{
    ...
    /// </summary>
    public new static Dictionary<BaseBodyArmorPickup, BodyArmorPickup> Dictionary { get; } = [];

    /// <summary>
    /// A reference to all instances of <see cref="BodyArmorPickup"/>.
    /// </summary>
    public new static IReadOnlyCollection<BodyArmorPickup> List => Dictionary.Values;
