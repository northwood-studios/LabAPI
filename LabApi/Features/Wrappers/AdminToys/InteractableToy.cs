...
public class InteractableToy : AdminToy
{
    ...
    /// </summary>
    public static new Dictionary<InvisibleInteractableToy, InteractableToy> Dictionary { get; } = [];

    /// <summary>
    /// A reference to all instances of <see cref="InteractableToy"/>.
    /// </summary>
    public static new IReadOnlyCollection<InteractableToy> List => Dictionary.Values;
