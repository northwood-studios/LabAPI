...
public class LightSourceToy : AdminToy
{
    ...
    /// </summary>
    public static new Dictionary<BaseLightSourceToy, LightSourceToy> Dictionary { get; } = [];

    /// <summary>
    /// A reference to all instances of <see cref="LightSourceToy"/>.
    /// </summary>
    public static new IReadOnlyCollection<LightSourceToy> List => Dictionary.Values;
