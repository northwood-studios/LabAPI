...
public class ShootingTargetToy : AdminToy
{
    ...
    /// </summary>
    public static new Dictionary<ShootingTarget, ShootingTargetToy> Dictionary { get; } = [];

    /// <summary>
    /// A reference to all instances of <see cref="ShootingTargetToy"/>.
    /// </summary>
    public static new IReadOnlyCollection<ShootingTargetToy> List => Dictionary.Values;
