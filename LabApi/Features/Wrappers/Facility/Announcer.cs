...
public static class Announcer
{
    ...
    /// <param name="priority">The priority of this message. The higher the value, the earlier it will be dequeued compared to lower-priority announcements.</param>
    ...
    /// <param name="priority">The priority of this message. The higher the value, the earlier it will be dequeued compared to lower-priority announcements.</param>
    /// <param name="glitchScale">Intensity of glitches and stutters added before sending to clients. Range from 0f to 1f.</param>
