...
public class Hazard
{
    ...
    /// </summary>
    protected static EnvironmentalHazard? BasePrefab { get; private set; }
    ...
    protected static T? GetPrefab<T>()
        where T : EnvironmentalHazard
    {
    ...
    private static void Register<T>(Func<T, Hazard> constructor)
        where T : EnvironmentalHazard
    {
