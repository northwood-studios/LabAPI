...
public class TantrumHazard : DecayableHazard
{
    ...
    /// </summary>
    public static new Dictionary<TantrumEnvironmentalHazard, TantrumHazard> Dictionary { get; } = [];

    /// <summary>
    /// Gets all currently active tantrum hazards.
    /// </summary>
    public static new IReadOnlyCollection<TantrumHazard> List => Dictionary.Values;

    /// <summary>
    /// Prefab used to spawn the hazard.
    /// </summary>
    protected static new TantrumEnvironmentalHazard? BasePrefab { get; private set; }
